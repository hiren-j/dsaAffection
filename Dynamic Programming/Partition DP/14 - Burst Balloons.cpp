...
/*
    DON'T IGNORE MUST READ: This Partition DP pattern is designed to help you understand different ways to partition an array or string to solve complex problems. The pattern contains a total of 14 problems:
        ...
        -> Problems 1 to 13: These problems involve making a single partition on the right side after reaching any point in the array or string. For example, consider an array [1, 2, 3]. If you choose index 1 as the partition point, you split the array into [1] and [2, 3]. 
        ...
        -> Problems 14 to 16: These problems involve making two cuts or two partitions simultaneously to cover multiple segments of the array or string. For example, with the array [1, 2, 3, 4, 5], if you make two cuts at indices 1 and 3, you divide the array into [1], [2, 3, 4], and [5]. 
                             Here, you are considering two cuts or two partitions at the same time to cover multiple segments.
    
        -> Difference: In problems 1 to 11, you only need to make one cut at a time to split the array or string into segments. In problems 14 to 16, you need to consider making two cuts simultaneously to define multiple segments. 
