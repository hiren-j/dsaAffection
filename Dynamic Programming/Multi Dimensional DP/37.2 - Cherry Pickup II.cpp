...
/*
    NOTE: In the previous solution If you notice then R1 and R2 are doing the same thing, we're using them to move to the next row, so instead of taking two variables, 
          Let's just maintain one variable R. 
*/
