...
class BottomUp {
    ...
    // Note: Let's remove the ternary checks inside the loop, To do we'll use dp[steps][0], index 0 will store results for negative index (-1), so we'll be using dp[steps][1], index 1 to store results for index 0, look below 
