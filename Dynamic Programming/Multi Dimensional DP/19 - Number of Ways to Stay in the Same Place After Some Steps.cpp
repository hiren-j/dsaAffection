...
class BottomUp {
    ...
    // Note: Let's remove the ternary checks inside the loop, To do we'll use dp[steps][0], index 0 will store results for negative index (-1), so originally index 1 will stores results for index 0, look below 
